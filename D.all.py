...
def logo():
    ...
    print("\033[94m│           \033[92m  _____            _      _      \033[94m          │".center(columns+14))
    print("\033[94m│           \033[92m |  __ \     /\   | |    | |     \033[94m          │".center(columns+14))
    print("\033[94m│           \033[92m | |  | |   /  \  | |    | |     \033[94m          │".center(columns+14))
    print("\033[94m│           \033[92m | |  | |  / /\ \ | |    | |     \033[94m          │".center(columns+14))
    print("\033[94m│           \033[92m | |__| | / ____ \| |____| |____     \033[94m          │".center(columns+14))
    print("\033[94m│           \033[92m |_____(_)_/    \_\______|______|      \033[94m          │".center(columns+14))
